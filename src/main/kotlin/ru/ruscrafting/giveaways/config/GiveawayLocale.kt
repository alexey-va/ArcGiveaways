...
enum class MessageKey(val path: String) {
    ...
    MENU_BACK_LABEL("menu-back-label"), MENU_CLOSE_LABEL("menu-close-label"),
    ...
    MENU_START_LABEL("menu-start-label"), MENU_START_TOOLTIP("menu-start-tooltip"),
    ...
    MENU_CONFIRM_BODY("menu-confirm-body"), MENU_CONFIRM_LABEL("menu-confirm-label"),
